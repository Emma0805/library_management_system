			...
			<div class="graphs">
				<div class="error-main">
					...
					<div class="col-xs-7 error-main-left">
						<p>Total books:<%=request.getAttribute("bookAllNumber") %></p>
						<p>Total books available:<%=request.getAttribute("bookAvilibleNumber") %></p>
						<p>Total books checked out:<%=request.getAttribute("bookCheckoutNumber") %></p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
