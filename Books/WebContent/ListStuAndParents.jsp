	...
	<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
		...
		<div class="panel-body no-padding">
								<table class="table table-striped">
									...
									<tbody>
									<%List<StudentAndParent> list = (List<StudentAndParent>)request.getAttribute("StuAndParents"); 
									if(list != null && list.size()>0){
										int number = 1;
										for(StudentAndParent student:list){
									%>
											<tr>
												<td><%=number %></td>
												<td><%=student.getStudent().getStudentId() %></td>
												<td><%=student.getStudent().getFirstName()%></td>
												<td><%=student.getStudent().getLastName() %></td>
												<td><%=student.getParent().getFirstName()%></td>
												<td><%=student.getParent().getLastName() %></td>
											</tr>
									<% 		number ++;
										}
									}%>
