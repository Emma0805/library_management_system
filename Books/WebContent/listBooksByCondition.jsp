...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
			...
			<form action="BooksCheckoutByClass" method="post">
				<div class="form-group">
					<label class="col-sm-1 control-label label-input-sm">Order by Class:</label>
					<div class="col-sm-2">
						<input type="radio" name="condition" value="c.classId" />
					</div>
					<label class="col-sm-1 control-label label-input-sm">Order by Book Name:</label>
					<div class="col-sm-2">
						<input type="radio" name="condition" value="b.name" />
					</div>
					<label class="col-sm-1 control-label label-input-sm">Order by Book Id:</label>
					<div class="col-sm-2">
						<input type="radio" name="condition" value="b.bookId" />
					</div>
				</div>
				<div class="row">
		...
		<div class="panel-body no-padding">
								<table class="table table-striped">
									...
									<tbody>
									<%List<BookAndClass> list = (List<BookAndClass>)request.getAttribute("books"); 
									if(list != null && list.size()>0){
										int number = 1;
										for(BookAndClass book:list){
									%>
											<tr>
												<td><%=number %></td>
