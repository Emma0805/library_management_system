 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		...
		<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
			<form action="Update?action=add" method="post">
			<div class="panel-body no-padding">
			<div class="form-group mb-n">
					<label class="col-md-1 control-label">Book Name:</label>
					<div class="col-md-8">
						<input name="name" type="text" class="form-control1">
					</div>
					<div class="clearfix"> </div>
					<label class="col-md-1 control-label">Author:</label>
					<div class="col-md-8">
						<input name="author" type="text" class="form-control1">
					</div>
					<div class="clearfix"> </div>
					<label class="col-md-1 control-label">ISBN:</label>
					<div class="col-md-8">
						<input name="ISBNV" type="text" class="form-control1">
					</div>
					<div class="clearfix"> </div>
			</div>
				<div class="row">
